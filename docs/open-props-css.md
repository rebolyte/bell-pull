...
We want to control our styles without a build step, so using Open Props gives us a big collection of CSS variables to use as the building blocks (colors, shadows, gradients, animations) for building components.

Documentation: https://open-props.style/

## Example: Building a component

from https://codepen.io/argyleink/pen/jOLaBgG
...
<style>
  ...
  @container (min-width: var(--size-content-2)) {
    .card {
...
<div class="component-wrapper">
  <article class="card">
    ...
    <div class="card-info">
      ...
      <p>Resize the outer box to see me transform using Open Props design tokens.</p>
...
from https://codepen.io/argyleink/pen/KKvRORE
